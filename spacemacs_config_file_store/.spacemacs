...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka Nerd Font" ;;"Iosevka", "VictorMono Nerd Font" ; SpaceMono Nerd Font "Fantasque Sans Mono"
                               ;;:size 15.0
                               :size 16.0
...
(custom-set-variables
 ...
 '(evil-want-Y-yank-to-eol t)
 '(minimap-window-location 'right)
 '(org-agenda-files '("~/Desktop/test_my_org.org"))
 '(org-export-backends '(ascii html icalendar latex md odt))
 '(package-selected-packages
   '(all-the-icons-ivy-rich counsel-css counsel-projectile counsel
                            flyspell-correct-ivy ivy-avy ivy-hydra ivy-purpose
                            ivy-rich ivy-rtags ivy-xref ivy-yasnippet lsp-ivy
                            smex swiper wgrep all-the-icons-ivy vterm zoxide
                            markdownfmt treemacs-all-the-icons
