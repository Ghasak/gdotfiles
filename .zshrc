...
# *************************************************************************
# *                  Configurations for fzf-tab plugin
# *************************************************************************
...
## *************************************************************************
function zvm_config() {
  #ZVM_LINE_INIT_MODE=$ZVM_MODE_NORMAL   # ZVM_MODE_INSERT
  ZVM_LINE_INIT_MODE=$ZVM_MODE_INSERT   # ZVM_MODE_INSERT
...
#============================================================================
alias vim='nvim'
export EDITOR=nvim   # Using NANO:/usr/bin/nano
export VISUAL=nvim
export PATH="$PATH:$HOME/.nvim/nvim/bin/"
# alias vim=~/.nvim/nvim/bin/nvim
# export EDITOR=nvim   # Using NANO:/usr/bin/nano
# export VISUAL=nvim
# ----------- Make Nvim Lazy Loading -------------
...
##################################################
#       Allow auto completions for Bash
##################################################
...
##################################################
#           Export my Own Scripts
##################################################
#for d in $HOME/.GScript/*; do PATH="$PATH:$d"; done
export PATH="$PATH:$HOME/.GScript/"
